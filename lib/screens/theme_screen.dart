...
class ThemesScreen extends StatelessWidget {
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar:fromOnBoarding
            ...
            : AppBar(title: Text(lan.getTexts('theme_appBar_title').toString()),),
        body: Column(
          children: [
            Container(
            ...
            Expanded(child: ListView(
              children: [
                Container(
                  padding: EdgeInsets.all(20),
                  child: Text(lan.getTexts('theme_mode_title').toString(),style: Theme.of(context).textTheme.headline6,),
                ),
  ...
  ListTile buildListTile(BuildContext context,txt){
    ...
    return ListTile(
      title: Text(txt=='primary'? lan.getTexts('primary').toString(): lan.getTexts('accent').toString(),style: Theme.of(context).textTheme.headline6,),
              ...
              return AlertDialog(
                ...
                content: SingleChildScrollView(
                  child: ColorPicker(
                    ...
                    Provider.of<ThemeProvider>(ctx,listen: false).onChanged(newColor, txt=='primary'?1:2),
